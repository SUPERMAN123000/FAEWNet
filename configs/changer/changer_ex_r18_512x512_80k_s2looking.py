...
#             dict(type='SpatialExchange', in_channels=128),
            dict(type='ChannelExchange', p=1/2),
            dict(type='ChannelExchange', p=1/2))
#             dict(type='ChannelExchange', channel=256),
#             dict(type='ChannelExchange', channel=512))
#             dict(type='Aggregation_distribution', channels=128),
#             dict(type='Aggregation_distribution', channels=256),
#             dict(type='Aggregation_distribution', channels=512))
    ),
    decode_head=dict(
        num_classes=2,
